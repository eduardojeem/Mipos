-- Inventory report aggregation RPC to avoid fetching large datasets to the client
...
REVOKE ALL ON FUNCTION public.get_inventory_report(uuid, text, text) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.get_inventory_report(uuid, text, text) TO authenticated;

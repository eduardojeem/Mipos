  ...
  achievements: [
    {
      ...
      description:
        "Superó las metas de ventas mensuales por 3 meses consecutivos",
      date: "2024-01-15",
      type: "sales",
    },
    {
      ...
      description:
        "Mantuvo una calificación de satisfacción superior a 4.5 estrellas",
      date: "2024-01-10",
      type: "customer",
    },
    {
...
export function PerformanceMetrics({
  ...
  const [editableGoals, setEditableGoals] = useState<SalesGoal>(
    defaultMetrics.salesGoals,
  );
          ...
          <CardContent>
            <div className="space-y-4">
              {[...Array(8)].map((_, i) => (
                <div
                  key={i}
                  className="h-4 bg-white/60 rounded-lg animate-pulse"
                />
              ))}
            </div>
          </CardContent>
                      ...
                      <>
                        ...
                        <Progress
                          value={calculateProgress(
                            metrics.currentSales.monthly,
                            metrics.salesGoals.monthly,
                          )}
                  ...
                  <CardContent>
                    {isEditing ? (
                      ...
                      <>
                        ...
                        <Progress
                          value={calculateProgress(
                            metrics.currentSales.quarterly,
                            metrics.salesGoals.quarterly,
                          )}
                  ...
                  <CardContent>
                    {isEditing ? (
                      ...
                      <>
                        ...
                        <Progress
                          value={calculateProgress(
                            metrics.currentSales.annual,
                            metrics.salesGoals.annual,
                          )}
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                          <div className="text-center">
                            <div className="flex items-center justify-center mb-2">
                              ...
                              {previousTrend &&
                                getTrendIcon(trend.sales, previousTrend.sales)}
                            </div>
            ...
            <TabsContent value="achievements" className="space-y-6">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Hitos alcanzados y metas superadas
                  </p>
                </div>
              </div>
                  ...
                  >
                    <CardContent className="p-6">
                      <div className="flex items-start space-x-4">
                        <div
                          className={`p-3 rounded-xl ${getAchievementColor(achievement.type)}`}
                        >

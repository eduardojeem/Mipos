  ...
  const getStatusBadge = (status: string) => {
    ...
    switch (status) {
      case "SUCCESS":
        return (
          <Badge
            className={`${baseClasses} bg-green-500/10 text-green-700 dark:bg-green-500/20 dark:text-green-400 border-green-200/50`}
          >
            Exitoso
          </Badge>
        );
      case "FAILURE":
        return (
          <Badge
            className={`${baseClasses} bg-destructive/10 text-destructive dark:bg-destructive/20 dark:text-destructive-foreground border-destructive/20`}
          >
            Fallido
          </Badge>
        );
                        ...
                        <TableCell>
                          <div className="flex flex-col">
                            <span className="font-semibold text-foreground">
                              {format(parseISO(log.createdAt), "dd/MM/yyyy", {
                                locale: es,
                              })}
                            </span>

  ...
  return (
    <MarketplaceLayout searchQuery={queryState.search}>
      <header className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1.35fr)_minmax(260px,320px)] lg:items-end">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-base leading-7 text-slate-600 dark:text-slate-400">
              Recorre el mapa real de rubros publicados por empresas activas y accede al catalogo ya
              filtrado desde cada categoria.
            </p>
            {queryState.search ? (
              <p className="mt-3 text-sm font-medium text-emerald-700 dark:text-emerald-300">
                Resultados para &quot;{queryState.search}&quot;
              </p>
            ) : null}
          </div>

          {/* Stats panel — single row, no nested cards */}
          <div className="rounded-xl border border-slate-200 bg-white/70 p-5 shadow-sm backdrop-blur-sm dark:border-slate-800 dark:bg-slate-950/70">
            ...
            <div className="mt-4 grid grid-cols-3 gap-2 divide-x divide-slate-100 dark:divide-slate-800">
              <div className="pr-2">
                <div className="flex items-center gap-1.5 text-slate-400">
                  <Layers3 className="h-3.5 w-3.5" />
                  <span className="text-[10px] font-semibold uppercase tracking-wider">Rubros</span>
                </div>
              ...
              <div className="pl-2">
                <div className="flex items-center gap-1.5 text-slate-400">
                  ...
                  <span className="text-[10px] font-semibold uppercase tracking-wider">Productos</span>
                </div>
                <p className="mt-2 text-2xl font-bold text-slate-900 dark:text-white">

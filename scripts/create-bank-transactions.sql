...
CREATE TABLE IF NOT EXISTS bank_transactions (
  ...
  type text NOT NULL DEFAULT 'DEBIT', -- DEBIT (expense) / CREDIT (income)
  source text, -- category/source for expense/income breakdown
  description text,
...
CREATE INDEX IF NOT EXISTS idx_bank_txn_source ON bank_transactions(source);
